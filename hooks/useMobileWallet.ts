...
export function useMobileWallet() {
  const { authorizeSessionWithSignIn, authorizeSession, deauthorizeSession, selectedAccount } =
    useAuthorization();
  ...
  return useMemo(
    ...
    [connect, signIn, disconnect, signAndSendTransaction, signMessage, selectedAccount]
  );
}
